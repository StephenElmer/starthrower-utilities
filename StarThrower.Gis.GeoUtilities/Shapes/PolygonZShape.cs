...
{
    /// <summary>
    /// One or more rings forming a polygon with Z (elevation) values. Corresponds to <see cref="ShapeType.PolygonZ"/>.
    /// </summary>
    /// <remarks>
    /// This class does not currently store any rings or Z values; it carries only its
    ...
    public class PolygonZShape : StarThrower.Gis.GeoUtilities.Shapes.Shape, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="PolygonZShape"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="PolygonZShape"/> as a copy of another instance.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A new <see cref="PolygonZShape"/> that is a copy of this instance.</returns>
        ...
        /// <exception cref="InvalidCastException"><paramref name="value"/> is not a <see cref="PolygonZShape"/>.</exception>
        ...
        /// <returns>true if <paramref name="obj"/> is a <see cref="PolygonZShape"/>; otherwise, false.</returns>
        ...
        /// </summary>
        /// <returns>A hash code for the current PolygonZShape.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this PolygonZShape.
        /// </summary>
