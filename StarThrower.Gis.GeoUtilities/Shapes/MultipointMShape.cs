...
{
    /// <summary>
    /// A set of points with measure values. Corresponds to <see cref="ShapeType.MultipointM"/>.
    /// </summary>
    /// <remarks>
    /// This class does not currently store any points or measure values; it carries only its
    ...
    public class MultipointMShape : StarThrower.Gis.GeoUtilities.Shapes.Shape, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="MultipointMShape"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="MultipointMShape"/> as a copy of another instance.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A new <see cref="MultipointMShape"/> that is a copy of this instance.</returns>
        ...
        /// <exception cref="InvalidCastException"><paramref name="value"/> is not a <see cref="MultipointMShape"/>.</exception>
        ...
        /// <returns>true if <paramref name="obj"/> is a <see cref="MultipointMShape"/>; otherwise, false.</returns>
        ...
        /// </summary>
        /// <returns>A hash code for the current MultipointMShape.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this MultipointMShape.
        /// </summary>
