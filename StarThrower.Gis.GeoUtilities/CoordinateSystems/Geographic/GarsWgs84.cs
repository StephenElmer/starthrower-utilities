...
{
    /// <summary>
    /// The Global Area Reference System (GARS), a WGS84-based alphanumeric grid reference system.
    /// </summary>
    /// <remarks>
    /// <see cref="ToGeodetic"/> and <see cref="FromGeodetic"/> do not currently perform any GARS
    /// grid-cell encoding or decoding; they accept and return plain decimal-degree coordinates unchanged.
    /// </remarks>
    public class GarsWgs84 : GeographicCoordinateSystem
    {
        #region Construction

        internal GarsWgs84() : base()
        {
        ...
        /// <summary>
        /// Returns the given coordinate unchanged. Does not decode a GARS grid-cell reference;
        ...
        /// <summary>
        /// Returns the given coordinate unchanged. Does not encode a GARS grid-cell reference;
        /// the returned x/y values are plain decimal-degree longitude/latitude, not a GARS cell.
        /// </summary>
        /// <param name="xLon">The longitude, in decimal degrees.</param>
        /// <param name="yLat">The latitude, in decimal degrees.</param>
        /// <param name="zAlt">The height/altitude.</param>
