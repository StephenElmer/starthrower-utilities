...
namespace StarThrower.Gis.GeoUtilities.CoordinateSystems.Projected
{
    ...
    public class Eckert4Wgs84 : ProjectedCoordinateSystem
    {
        ...
        internal Eckert4Wgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal Eckert4Wgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.Eckert4(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
