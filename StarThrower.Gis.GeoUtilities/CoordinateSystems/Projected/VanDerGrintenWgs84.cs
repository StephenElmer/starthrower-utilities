...
{
    /// <summary>
    /// A <see cref="Projections.VanDerGrinten"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class VanDerGrintenWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal VanDerGrintenWgs84() : this(0.0, 0.0, 0.0) { }

        internal VanDerGrintenWgs84(double falseEasting, double falseNorthing, double centralMeridian)
        {
            ...
            this.Projection = new Projections.VanDerGrinten(falseEasting, falseNorthing, centralMeridian);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert VanDerGrintenWgs84
        ...
        /// to VanDerGrintenWgs84 projected (easting/northing) coordinates. It returns the
