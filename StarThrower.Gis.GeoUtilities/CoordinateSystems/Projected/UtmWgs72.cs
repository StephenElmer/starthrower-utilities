...
namespace StarThrower.Gis.GeoUtilities.CoordinateSystems.Projected
{
    ...
    /// </summary>
    public class UtmWgs72 : ProjectedCoordinateSystem, IZonedCoordinateSystem
    {
        ...
        internal UtmWgs72() : this(new Zones.UndefinedZone()) { }

        internal UtmWgs72(IZone zone)
        {
        ...
        {
            //IZone zone = new Zones.Utm.UtmZone(xLon, yLat);
