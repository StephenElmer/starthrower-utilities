...
namespace StarThrower.Gis.GeoUtilities.CoordinateSystems.Projected
{
    public class CassiniWgs84 : ProjectedCoordinateSystem
    {
        ...
        /// <summary>
        /// Translates the specified coordinates from Cassini to Geodetic WGS84 coordinates
        /// </summary>
        ...
        /// <summary>
        /// Translates the specified coordinates from Geodetic WGS84 to Cassini coordinates
        /// </summary>
