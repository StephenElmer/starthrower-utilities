...
{
    /// <summary>
    /// A <see cref="Projections.Cassini"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class CassiniWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal CassiniWgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal CassiniWgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.Cassini(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert CassiniWgs84
        ...
        /// to CassiniWgs84 projected (easting/northing) coordinates. It returns the
