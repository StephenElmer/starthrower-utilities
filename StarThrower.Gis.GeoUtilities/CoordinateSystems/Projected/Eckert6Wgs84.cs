...
{
    /// <summary>
    /// A <see cref="Projections.Eckert6"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class Eckert6Wgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal Eckert6Wgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal Eckert6Wgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.Eckert6(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert Eckert6Wgs84
        ...
        /// to Eckert6Wgs84 projected (easting/northing) coordinates. It returns the
