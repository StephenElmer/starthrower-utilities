...
{
    /// <summary>
    /// A <see cref="Projections.Mollweide"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class MollweideWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal MollweideWgs84() : this(0.0, 0.0, 0.0) { }

        internal MollweideWgs84(double falseEasting, double falseNorthing, double centralMeridian)
        {
            ...
            this.Projection = new Projections.Mollweide(falseEasting, falseNorthing, centralMeridian);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert MollweideWgs84
        ...
        /// to MollweideWgs84 projected (easting/northing) coordinates. It returns the
