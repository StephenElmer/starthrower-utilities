...
{
    /// <summary>
    /// A <see cref="Projections.Stereographic"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class StereographicWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal StereographicWgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal StereographicWgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.Stereographic(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert StereographicWgs84
        ...
        /// to StereographicWgs84 projected (easting/northing) coordinates. It returns the
