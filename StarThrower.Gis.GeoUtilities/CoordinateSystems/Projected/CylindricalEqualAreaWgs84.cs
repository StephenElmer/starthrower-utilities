...
{
    /// <summary>
    /// A <see cref="Projections.CylindricalEqualArea"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class CylindricalEqualAreaWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal CylindricalEqualAreaWgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal CylindricalEqualAreaWgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.CylindricalEqualArea(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert CylindricalEqualAreaWgs84
        ...
        /// to CylindricalEqualAreaWgs84 projected (easting/northing) coordinates. It returns the
