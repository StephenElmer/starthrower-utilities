...
{
    /// <summary>
    /// A <see cref="Projections.Bonne"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class BonneWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal BonneWgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal BonneWgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.Bonne(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert BonneWgs84
        ...
        /// to BonneWgs84 projected (easting/northing) coordinates. It returns the
