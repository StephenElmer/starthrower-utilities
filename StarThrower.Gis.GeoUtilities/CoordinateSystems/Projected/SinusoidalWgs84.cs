...
{
    /// <summary>
    /// A <see cref="Projections.Sinusoidal"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class SinusoidalWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal SinusoidalWgs84() : this(0.0, 0.0, 0.0) { }

        internal SinusoidalWgs84(double falseEasting, double falseNorthing, double centralMeridian)
        {
            ...
            this.Projection = new Projections.Sinusoidal(falseEasting, falseNorthing, centralMeridian);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert SinusoidalWgs84
        ...
        /// to SinusoidalWgs84 projected (easting/northing) coordinates. It returns the
