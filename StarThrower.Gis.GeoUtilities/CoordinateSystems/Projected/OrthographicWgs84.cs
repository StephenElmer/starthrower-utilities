...
{
    /// <summary>
    /// A <see cref="Projections.Orthographic"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class OrthographicWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal OrthographicWgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal OrthographicWgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.Orthographic(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert OrthographicWgs84
        ...
        /// to OrthographicWgs84 projected (easting/northing) coordinates. It returns the
