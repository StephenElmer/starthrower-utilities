...
{
    /// <summary>
    /// A <see cref="Projections.AzimuthalEquidistant"/>-projected coordinate system based on the WGS84
    /// geodetic datum.
    /// </summary>
    public class AzimuthalEquidistantWgs84 : ProjectedCoordinateSystem
    {
        #region Construction

        internal AzimuthalEquidistantWgs84() : this(0.0, 0.0, 0.0, 0.0) { }

        internal AzimuthalEquidistantWgs84(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
            ...
            this.Projection = new Projections.AzimuthalEquidistant(falseEasting, falseNorthing, centralMeridian, latitudeOfOrigin);
        ...
        /// <summary>
        /// Not yet implemented: this override does not convert AzimuthalEquidistantWgs84
        ...
        /// to AzimuthalEquidistantWgs84 projected (easting/northing) coordinates. It returns the
