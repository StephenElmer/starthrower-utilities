...
namespace StarThrower.Gis.GeoUtilities
{
    ...
    public static class DatumFactory
    {
        ...
        /// <param name="deltaX">The shift in the X direction to convert to WGS 84 (meters) of the Datum you are looking for.</param>
        /// <param name="sigmaX">The standard error in the X direction to convert to WGS 84 (meters) of the Datum you are looking for.</param>
        /// <param name="deltaY">The shift in the Y direction to convert to WGS 84 (meters) of the Datum you are looking for.</param>
        /// <param name="sigmaY">The standard error in the Y direction to convert to WGS 84 (meters) of the Datum you are looking for.</param>
        /// <param name="deltaZ">The shift in the Z direction to convert to WGS 84 (meters) of the Datum you are looking for.</param>
        /// <param name="sigmaZ">The standard error in the Z direction to convert to WGS 84 (meters) of the Datum you are looking for.</param>
        /// <param name="rotationX">The rotation in the X direction of the Datum you are looking for.</param>
        /// <param name="rotationY">The rotation in the Y direction of the Datum you are looking for.</param>
        /// <param name="rotationZ">The rotation in the Z direction of the Datum you are looking for.</param>
        /// <param name="rotationScaleFactor">The scale factor for the rotation of the Datum you are looking for.</param>
        /// <param name="north">The northern boundary (in decimal degrees) of the valid domain of the Datum you are looking for.</param>
        /// <param name="south">The southern boundary (in decimal degrees) of the valid domain of the Datum you are looking for.</param>
        /// <param name="east">The eastern boundary (in decimal degrees) of the valid domain of the Datum you are looking for.</param>
        /// <param name="west">The western boundary (in decimal degrees) of the valid domain of the Datum you are looking for.</param>
        ...
        /// <param name="deltaX">The shift in the X direction to convert to WGS 84 (meters).</param>
        /// <param name="sigmaX">The standard error in the X direction to convert to WGS 84 (meters).</param>
        /// <param name="deltaY">The shift in the Y direction to convert to WGS 84 (meters).</param>
        /// <param name="sigmaY">The standard error in the Y direction to convert to WGS 84 (meters).</param>
        /// <param name="deltaZ">The shift in the Z direction to convert to WGS 84 (meters).</param>
        /// <param name="sigmaZ">The standard error in the Z direction to convert to WGS 84 (meters).</param>
        /// <param name="rotationX">The rotation in the X direction.</param>
        /// <param name="rotationY">The rotation in the Y direction.</param>
        /// <param name="rotationZ">The rotation in the Z direction.</param>
        /// <param name="rotationScaleFactor">The scale factor for the rotation.</param>
        /// <param name="north">The northern boundary (in decimal degrees) of the new Datum's valid domain.</param>
        /// <param name="south">The southern boundary (in decimal degrees) of the new Datum's valid domain.</param>
        /// <param name="east">The eastern boundary (in decimal degrees) of the new Datum's valid domain.</param>
        /// <param name="west">The western boundary (in decimal degrees) of the new Datum's valid domain.</param>
