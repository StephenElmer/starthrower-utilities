...
namespace StarThrower.Gis.GeoUtilities.Projections
{
    public class EquidistantCylindrical : IProjection
    {
        public static bool ValidateParameters(ProjectionParameter[] parameters)
        {
            ...
            if (!parameters[2].Name.Equals("Central_Meridian")) return false;
            if (!parameters[3].Name.Equals("Standard_Parallel")) return false;
            return true;
        }
        ...
        private double _standardParallel;
        ...
        internal EquidistantCylindrical(ProjectionParameter[] parameters)
        {
            ...
            _standardParallel = parameters[3].Value;
        }

        internal EquidistantCylindrical(double falseEasting, double falseNorthing, double centralMeridian, double standardParallel)
        {
            _falseEasting = falseEasting;
            _falseNorthing = falseNorthing;
            _centralMeridian = centralMeridian;
            _standardParallel = standardParallel;
        }
        ...
        public string ToXml()
        {
            ...
            result.AppendLine("<parameter name=\"Standard_Parallel\" value=\"" + _standardParallel.ToString(CultureInfo.InvariantCulture) + "\"/>");
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is EquidistantCylindrical)) return false;
            EquidistantCylindrical other = (EquidistantCylindrical)obj;
            return _falseEasting.Equals(other._falseEasting) &&
                   ...
                   _standardParallel.Equals(other._standardParallel);
        }

        /// <summary>
        /// Serves as a hash function for a particular type. GetHashCode is suitable for use in hashing algorithms and data structures like a hash table.
        /// </summary>
        /// <returns>A hash code for the current EquidistantCylindrical Projection.</returns>
        public override int GetHashCode()
        {
            ...
            result = 31 * result + _standardParallel.GetHashCode();
            return result;
        }

        /// <summary>
        /// Returns the string representation of this EquidistantCylindrical Projection.
        /// </summary>
        ...
        {
            return "[" + this.GetType().Name + ":  FalseEasting=" + _falseEasting.ToString(CultureInfo.InvariantCulture) + ", FalseNorthing=" + _falseNorthing.ToString(CultureInfo.InvariantCulture) + ", CentralMeridian=" + _centralMeridian.ToString(CultureInfo.InvariantCulture) + ", StandardParallel=" + _standardParallel.ToString(CultureInfo.InvariantCulture) + "]";
        }
