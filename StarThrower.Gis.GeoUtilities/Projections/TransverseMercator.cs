...
{
    /// <summary>
    /// The Transverse Mercator map projection: a transverse-axis, conformal cylindrical
    /// projection commonly used as the basis for UTM, parameterized by a scale factor,
    /// latitude of origin, central meridian, and false easting/northing.
    /// </summary>
    public class TransverseMercator : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="TransverseMercator"/> projection.
        /// </summary>
        ...
        /// "Central_Meridian", "Scale_Factor", and "Latitude_of_Origin"; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        internal TransverseMercator(ProjectionParameter[] parameters)
        {
        ...
        internal TransverseMercator(double falseEasting, double falseNorthing, double centralMeridian, double scaleFactor, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is TransverseMercator)) return false;
            TransverseMercator other = (TransverseMercator)obj;
