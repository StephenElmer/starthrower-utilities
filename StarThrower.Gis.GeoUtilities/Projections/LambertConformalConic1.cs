...
{
    /// <summary>
    /// The Lambert Conformal Conic (one standard parallel) map projection: a conic projection
    /// that preserves angles, parameterized by a latitude of origin, scale factor, central
    /// meridian, and false easting/northing.
    /// </summary>
    public class LambertConformalConic1 : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="LambertConformalConic1"/> projection.
        /// </summary>
        ...
        public static bool ValidateParameters(ProjectionParameter[] parameters)
        {
            ...
            if (!parameters[4].Name.Equals("Scale_Factor", StringComparison.Ordinal)) return false;
            return true;
        }
        ...
        internal LambertConformalConic1(ProjectionParameter[] parameters)
        {
            ...
            _scaleFactor = parameters[4].Value;
        }

        internal LambertConformalConic1(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin, double scaleFactor)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is LambertConformalConic1)) return false;
            LambertConformalConic1 other = (LambertConformalConic1)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current LambertConformalConic1 Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this LambertConformalConic1 Projection.
        /// </summary>
