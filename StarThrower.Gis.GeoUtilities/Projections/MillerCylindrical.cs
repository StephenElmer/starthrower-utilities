...
namespace StarThrower.Gis.GeoUtilities.Projections
{
    public class MillerCylindrical : IProjection
    {
        ...
        internal MillerCylindrical(ProjectionParameter[] parameters)
        {
        ...
        internal MillerCylindrical(double falseEasting, double falseNorthing, double centralMeridian)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is MillerCylindrical)) return false;
            MillerCylindrical other = (MillerCylindrical)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current MillerCylindrical Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this MillerCylindrical Projection.
        /// </summary>
