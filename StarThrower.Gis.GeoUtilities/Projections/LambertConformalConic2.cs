...
{
    /// <summary>
    /// The Lambert Conformal Conic (two standard parallels) map projection: a conic projection
    /// that preserves angles, parameterized by two standard parallels, a latitude of origin,
    /// a central meridian, and false easting/northing.
    /// </summary>
    public class LambertConformalConic2 : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="LambertConformalConic2"/> projection.
        /// </summary>
        /// <param name="parameters">The parameters to validate.</param>
        /// <returns>
        /// <see langword="true"/> if <paramref name="parameters"/> is non-null, has exactly 6
        /// elements, and the elements are named, in order, "False_Easting", "False_Northing",
        /// "Central_Meridian", "Latitude_of_Origin", "Standard_Parallel_1", and
        /// "Standard_Parallel_2"; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// <summary>
        /// Gets the Standard_Parallel_1 parameter value.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Standard_Parallel_2 parameter value.
        /// </summary>
        ...
        internal LambertConformalConic2(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin, double standardParallel1, double standardParallel2)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is LambertConformalConic2)) return false;
            LambertConformalConic2 other = (LambertConformalConic2)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current LambertConformalConic2 Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this LambertConformalConic2 Projection.
        /// </summary>
