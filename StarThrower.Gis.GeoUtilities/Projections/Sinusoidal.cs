...
{
    /// <summary>
    /// The Sinusoidal map projection: a pseudocylindrical, equal-area projection on which
    /// parallels are straight, evenly-spaced lines, parameterized by a central meridian and
    /// false easting/northing.
    /// </summary>
    public class Sinusoidal : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Sinusoidal"/> projection.
        /// </summary>
        ...
        internal Sinusoidal(ProjectionParameter[] parameters)
        {
        ...
        internal Sinusoidal(double falseEasting, double falseNorthing, double centralMeridian)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is Sinusoidal)) return false;
            Sinusoidal other = (Sinusoidal)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current Sinusoidal Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Sinusoidal Projection.
        /// </summary>
