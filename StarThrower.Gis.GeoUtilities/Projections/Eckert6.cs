...
{
    /// <summary>
    /// The Eckert VI map projection: a pseudocylindrical, equal-area projection parameterized
    /// by a latitude of origin, central meridian, and false easting/northing.
    /// </summary>
    public class Eckert6 : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Eckert6"/> projection.
        /// </summary>
        ...
        internal Eckert6(ProjectionParameter[] parameters)
        {
        ...
        internal Eckert6(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is Eckert6)) return false;
            Eckert6 other = (Eckert6)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current Eckert6 Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Eckert6 Projection.
        /// </summary>
