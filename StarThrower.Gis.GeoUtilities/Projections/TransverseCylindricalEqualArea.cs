...
namespace StarThrower.Gis.GeoUtilities.Projections
{
    public class TransverseCylindricalEqualArea : IProjection
    {
        public static bool ValidateParameters(ProjectionParameter[] parameters)
        {
            ...
            if (!parameters[3].Name.Equals("Latitude_of_Origin")) return false;
            if (!parameters[4].Name.Equals("Scale_Factor")) return false;
            return true;
        }
        ...
        internal TransverseCylindricalEqualArea(ProjectionParameter[] parameters)
        {
        ...
        internal TransverseCylindricalEqualArea(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin, double scaleFactor)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is TransverseCylindricalEqualArea)) return false;
            TransverseCylindricalEqualArea other = (TransverseCylindricalEqualArea)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current TransverseCylindricalEqualArea Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this TransverseCylindricalEqualArea Projection.
        /// </summary>
