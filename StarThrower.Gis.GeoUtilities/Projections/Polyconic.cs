...
{
    /// <summary>
    /// The Polyconic map projection: a conic projection in which each parallel uses its own
    /// cone, parameterized by a latitude of origin, central meridian, and false easting/northing.
    /// </summary>
    public class Polyconic : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Polyconic"/> projection.
        /// </summary>
        ...
        internal Polyconic(ProjectionParameter[] parameters)
        {
        ...
        internal Polyconic(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is Polyconic)) return false;
            Polyconic other = (Polyconic)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current Polyconic Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Polyconic Projection.
        /// </summary>
