...
{
    /// <summary>
    /// The Azimuthal Equidistant map projection: an azimuthal projection that preserves
    /// distances from the center point, parameterized by a latitude of origin, central
    ...
    public class AzimuthalEquidistant : IProjection
    {
        ...
        /// by the <see cref="AzimuthalEquidistant"/> projection.
        /// </summary>
        ...
        internal AzimuthalEquidistant(ProjectionParameter[] parameters)
        {
        ...
        internal AzimuthalEquidistant(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is AzimuthalEquidistant)) return false;
            AzimuthalEquidistant other = (AzimuthalEquidistant)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current AzimuthalEquidistant Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this AzimuthalEquidistant Projection.
        /// </summary>
