...
namespace StarThrower.Gis.GeoUtilities.Projections
{
    ...
    public class Bonne : IProjection
    {
        ...
        internal Bonne(ProjectionParameter[] parameters)
        {
        ...
        internal Bonne(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is Bonne)) return false;
            Bonne other = (Bonne)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current Bonne Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Bonne Projection.
        /// </summary>
