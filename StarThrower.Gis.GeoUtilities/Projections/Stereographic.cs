...
{
    /// <summary>
    /// The Stereographic map projection: an azimuthal, conformal projection, parameterized by
    /// a latitude of origin, central meridian, and false easting/northing.
    /// </summary>
    public class Stereographic : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Stereographic"/> projection.
        /// </summary>
