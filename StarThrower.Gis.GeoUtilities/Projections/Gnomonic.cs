...
{
    /// <summary>
    /// The Gnomonic map projection: an azimuthal projection on which all great circles are
    /// straight lines, parameterized by a latitude of origin, central meridian, and false
    /// easting/northing.
    /// </summary>
    public class Gnomonic : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Gnomonic"/> projection.
        /// </summary>
        ...
        internal Gnomonic(ProjectionParameter[] parameters)
        {
        ...
        internal Gnomonic(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is Gnomonic)) return false;
            Gnomonic other = (Gnomonic)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current Gnomonic Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Gnomonic Projection.
        /// </summary>
