...
{
    /// <summary>
    /// The Ney's (modified Lambert Conformal Conic) map projection, commonly used for polar
    /// regions, parameterized by a standard parallel, a latitude of origin, a central
    /// meridian, and false easting/northing.
    /// </summary>
    public class Neys : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Neys"/> projection.
        /// </summary>
        ...
        /// "Central_Meridian", "Latitude_of_Origin", and "Standard_Parallel_1"; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        internal Neys(ProjectionParameter[] parameters)
        {
        ...
        internal Neys(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin, double standardParallel1)
        {
        ...
        /// </summary>
        /// <returns>A hash code for the current Neys Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Neys Projection.
        /// </summary>
