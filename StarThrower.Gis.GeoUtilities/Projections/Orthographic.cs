...
{
    /// <summary>
    /// The Orthographic map projection: an azimuthal projection that depicts the Earth as seen
    /// from an infinite distance in space, parameterized by a latitude of origin, central
    /// meridian, and false easting/northing.
    /// </summary>
    public class Orthographic : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Orthographic"/> projection.
        /// </summary>
        ...
        internal Orthographic(ProjectionParameter[] parameters)
        {
        ...
        internal Orthographic(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is Orthographic)) return false;
            Orthographic other = (Orthographic)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current Orthographic Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Orthographic Projection.
        /// </summary>
