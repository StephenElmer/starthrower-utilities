...
{
    /// <summary>
    /// The Van der Grinten map projection: a compromise (neither equal-area nor conformal)
    /// projection that depicts the whole Earth within a circle, parameterized by a central
    /// meridian and false easting/northing.
    /// </summary>
    public class VanDerGrinten : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="VanDerGrinten"/> projection.
        /// </summary>
        ...
        internal VanDerGrinten(ProjectionParameter[] parameters)
        {
        ...
        internal VanDerGrinten(double falseEasting, double falseNorthing, double centralMeridian)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is VanDerGrinten)) return false;
            VanDerGrinten other = (VanDerGrinten)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current VanDerGrinten Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this VanDerGrinten Projection.
        /// </summary>
