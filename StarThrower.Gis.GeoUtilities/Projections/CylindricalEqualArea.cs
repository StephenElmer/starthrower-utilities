...
{
    /// <summary>
    /// The Cylindrical Equal-Area map projection: a cylindrical projection that preserves
    /// area, parameterized by a latitude of origin, central meridian, and false easting/northing.
    /// </summary>
    public class CylindricalEqualArea : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="CylindricalEqualArea"/> projection.
        /// </summary>
        ...
        internal CylindricalEqualArea(ProjectionParameter[] parameters)
        {
        ...
        internal CylindricalEqualArea(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is CylindricalEqualArea)) return false;
            CylindricalEqualArea other = (CylindricalEqualArea)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current CylindricalEqualArea Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this CylindricalEqualArea Projection.
        /// </summary>
