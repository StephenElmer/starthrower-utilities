...
{
    /// <summary>
    /// The Cassini map projection: a cylindrical projection that preserves distances along the
    /// central meridian, parameterized by a latitude of origin, central meridian, and false
    /// easting/northing.
    /// </summary>
    public class Cassini : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Cassini"/> projection.
        /// </summary>
        ...
        internal Cassini(ProjectionParameter[] parameters)
        {
        ...
        internal Cassini(double falseEasting, double falseNorthing, double centralMeridian, double latitudeOfOrigin)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            if (!(obj is Cassini)) return false;
            Cassini other = (Cassini)obj;
        ...
        /// </summary>
        /// <returns>A hash code for the current Cassini Projection.</returns>
        ...
        /// <summary>
        /// Returns the string representation of this Cassini Projection.
        /// </summary>
