...
{
    /// <summary>
    /// The Mercator map projection: a cylindrical projection that preserves angles (conformal),
    /// commonly used for navigation, parameterized by a central meridian, latitude of origin,
    /// scale factor, and false easting/northing.
    /// </summary>
    public class Mercator : IProjection
    {
        /// <summary>
        /// Validates that the given array of parameters matches the names and order required
        /// by the <see cref="Mercator"/> projection.
        /// </summary>
