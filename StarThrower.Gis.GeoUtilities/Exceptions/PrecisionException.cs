...
namespace StarThrower.Gis.GeoUtilities.Exceptions
{
    ...
    public class PrecisionException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PrecisionException class with serialized data.
        /// </summary>
        /// <param name="info">The object that holds the serialized object data.</param>
        /// <param name="context">The contextual information about the source or destination.</param>
        protected PrecisionException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : base(info, context) { }
    }
}
