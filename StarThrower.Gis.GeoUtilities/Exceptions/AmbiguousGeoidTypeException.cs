...
namespace StarThrower.Gis.GeoUtilities.Exceptions
{
    ...
    public class AmbiguousGeoidTypeException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AmbiguousGeoidTypeException class with serialized data.
        /// </summary>
        /// <param name="info">The object that holds the serialized object data.</param>
        /// <param name="context">The contextual information about the source or destination.</param>
        protected AmbiguousGeoidTypeException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) : base(info, context) { }
    }
}
