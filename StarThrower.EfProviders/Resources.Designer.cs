...
namespace StarThrower.EfProviders {
    ...
    internal class Resources {
        ...
        internal static global::System.Resources.ResourceManager ResourceManager {
            get {
                if (object.ReferenceEquals(resourceMan, null)) {
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("StarThrower.EfProviders.Resources", typeof(Resources).Assembly);
                    resourceMan = temp;
                }
                return resourceMan;
            }
        ...
        /// <summary>
        ///   Looks up a localized string similar to SqlWebEventProvider: connectionString can only contain connection strings that use Sql Server authentication.  Trusted Connection security is not supported..
        /// </summary>
        internal static string Cannot_use_integrated_security {
            get {
                return ResourceManager.GetString("Cannot_use_integrated_security", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unable to connect to SQL Server session database. The connection string (server=&apos;{1}&apos;, database=&apos;{2}&apos;) was returned by an instance of the IPartitionResolver type &apos;{0}&apos;..
        /// </summary>
        ...
        internal static string Membership_password_too_long {
            get {
                return ResourceManager.GetString("Membership_password_too_long", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to SQL membership provider..
        /// </summary>
        internal static string MembershipSqlProvider_description {
            get {
                return ResourceManager.GetString("MembershipSqlProvider_description", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to SqlWebEventProvider: Either a connectionString or connectionStringName must be specified..
        /// </summary>
        internal static string Must_specify_connection_string_or_name {
            get {
                return ResourceManager.GetString("Must_specify_connection_string_or_name", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Unable to use SQL Server because ASP.NET version 2.0 Session State is not installed on the SQL server. Please install ASP.NET Session State SQL Server version 2.0 or above..
        /// </summary>
        internal static string Need_v2_SQL_Server {
            get {
                return ResourceManager.GetString("Need_v2_SQL_Server", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Unable to use SQL Server because ASP.NET version 2.0 Session State is not installed on the SQL server. Please install ASP.NET Session State SQL Server version 2.0 or above. The connection string (server=&apos;{1}&apos;, database=&apos;{2}&apos;) was returned by an instance of the IPartitionResolver type &apos;{0}&apos;..
        /// </summary>
        internal static string Need_v2_SQL_Server_partition_resolver {
            get {
                return ResourceManager.GetString("Need_v2_SQL_Server_partition_resolver", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to SqlWebEventProvider: Specify either a connectionString or connectionStringName, not both..
        /// </summary>
        internal static string Only_one_connection_string_allowed {
            get {
                return ResourceManager.GetString("Only_one_connection_string_allowed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to SQL profile provider..
        /// </summary>
        internal static string ProfileSqlProvider_description {
            get {
                return ResourceManager.GetString("ProfileSqlProvider_description", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0} is not a valid application..
        /// </summary>
        internal static string Provider_application_not_found {
            get {
                return ResourceManager.GetString("Provider_application_not_found", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The &apos;{0}&apos; requires a database schema compatible with schema version &apos;{1}&apos;.  However, the current database schema is not compatible with this version.  You may need to either install a compatible schema with aspnet_regsql.exe (available in the framework installation directory), or upgrade the provider to a newer version..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The user &apos;{0}&apos; was not found in the database..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Entity Framework role provider..
        /// </summary>
        ...
        internal static string SQL_Services_Error_Cant_use_custom_database {
            get {
                return ResourceManager.GetString("SQL_Services_Error_Cant_use_custom_database", resourceCulture);
            }
        }
        ...
        internal static string SQL_Services_Error_missing_custom_database {
            get {
                return ResourceManager.GetString("SQL_Services_Error_missing_custom_database", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0} events were discarded since last notification was made at {1} because the event buffer capacity was exceeded..
        /// </summary>
        internal static string Sql_webevent_provider_events_dropped {
            get {
                return ResourceManager.GetString("Sql_webevent_provider_events_dropped", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to An error occurred while attempting to initialize a System.Data.SqlClient.SqlConnection object. The value that was provided for the connection string may be wrong, or it may contain an invalid syntax..
        /// </summary>
        internal static string SqlError_Connection_String {
            get {
                return ResourceManager.GetString("SqlError_Connection_String", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to SQL Express filename was not found in the connection string..
        /// </summary>
        internal static string SqlExpress_file_not_found_in_connection_string {
            get {
                return ResourceManager.GetString("SqlExpress_file_not_found_in_connection_string", resourceCulture);
            }
        }
