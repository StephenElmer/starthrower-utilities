...
{
    /// <summary>
    /// Represents the Esri/XBase Boolean (Logical, type code 'L') field type. Delegates its
    /// validation and length/decimal-count constraints to
    /// <see cref="StarThrower.XBase.BooleanField"/>.
    /// </summary>
    public class BooleanField : StarThrower.Gis.EsriLibrary.Types.FieldType
    {
        #region Private Member Variables

        private StarThrower.XBase.BooleanField _field = new StarThrower.XBase.BooleanField();
        ...
        /// <summary>
        /// Initializes a new <see cref="BooleanField"/>, copying its type code and display
        /// name from the underlying <see cref="StarThrower.XBase.BooleanField"/>.
        /// </summary>
        public BooleanField()
        {
        ...
        /// <summary>
        /// Gets the minimum field length, in characters, allowed for a Boolean field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum field length, in characters, allowed for a Boolean field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the minimum decimal count allowed for a Boolean field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum decimal count allowed for a Boolean field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified field length is valid for a Boolean field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified decimal count is valid for a Boolean field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified in-memory value is valid for a Boolean field and, if
        /// so, converts it to its fixed-width text representation for storage in a .dbf record.
        /// </summary>
        ...
        /// <summary>
        /// Converts the fixed-width text representation of a Boolean field's data, as stored
        /// in a .dbf record, into its corresponding in-memory .NET value.
        /// </summary>
