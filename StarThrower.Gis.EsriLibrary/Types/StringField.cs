...
{
    /// <summary>
    /// Represents the Esri/XBase Character (String, type code 'C') field type. Delegates its
    /// validation and length/decimal-count constraints to
    /// <see cref="StarThrower.XBase.StringField"/>.
    /// </summary>
    public class StringField : StarThrower.Gis.EsriLibrary.Types.FieldType
    {
        #region Private Member Variables

        private StarThrower.XBase.StringField _field = new StarThrower.XBase.StringField();
        ...
        /// <summary>
        /// Initializes a new <see cref="StringField"/>, copying its type code and display
        /// name from the underlying <see cref="StarThrower.XBase.StringField"/>.
        /// </summary>
        public StringField()
        {
        ...
        /// <summary>
        /// Gets the minimum field length, in characters, allowed for a String field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum field length, in characters, allowed for a String field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the minimum decimal count allowed for a String field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum decimal count allowed for a String field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified field length is valid for a String field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified decimal count is valid for a String field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified in-memory value is valid for a String field and, if
        ...
        /// <summary>
        /// Converts the fixed-width text representation of a String field's data, as stored
