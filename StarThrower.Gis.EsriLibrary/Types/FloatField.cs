...
{
    /// <summary>
    /// Represents the Esri/XBase Float (type code 'F') field type, for floating-point numeric
    /// data. Delegates its validation and length/decimal-count constraints to
    /// <see cref="StarThrower.XBase.FloatField"/>.
    /// </summary>
    public class FloatField : StarThrower.Gis.EsriLibrary.Types.FieldType
    {
        #region Private Member Variables

        private StarThrower.XBase.FloatField _field = new StarThrower.XBase.FloatField();
        ...
        /// <summary>
        /// Initializes a new <see cref="FloatField"/>, copying its type code and display name
        /// from the underlying <see cref="StarThrower.XBase.FloatField"/>.
        /// </summary>
        public FloatField()
        {
        ...
        /// <summary>
        /// Gets the minimum field length, in characters, allowed for a Float field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum field length, in characters, allowed for a Float field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the minimum decimal count allowed for a Float field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum decimal count allowed for a Float field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified field length is valid for a Float field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified decimal count is valid for a Float field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified in-memory value is valid for a Float field and, if so,
        ...
        /// <summary>
        /// Converts the fixed-width text representation of a Float field's data, as stored in
