...
{
    /// <summary>
    /// Represents the Esri/XBase Numeric (type code 'N') field type. Delegates its
    /// validation and length/decimal-count constraints to
    /// <see cref="StarThrower.XBase.NumericField"/>.
    /// </summary>
    public class NumericField : StarThrower.Gis.EsriLibrary.Types.FieldType
    {
        #region Private Member Variables

        private StarThrower.XBase.NumericField _field = new StarThrower.XBase.NumericField();
        ...
        /// <summary>
        /// Initializes a new <see cref="NumericField"/>, copying its type code and display
        /// name from the underlying <see cref="StarThrower.XBase.NumericField"/>.
        /// </summary>
        public NumericField()
        {
        ...
        /// <summary>
        /// Gets the minimum field length, in characters, allowed for a Numeric field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum field length, in characters, allowed for a Numeric field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the minimum decimal count allowed for a Numeric field.
        /// </summary>
        ...
        /// <summary>
        /// Gets the maximum decimal count allowed for a Numeric field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified field length is valid for a Numeric field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified decimal count is valid for a Numeric field.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the specified in-memory value is valid for a Numeric field and, if
        ...
        /// <summary>
        /// Converts the fixed-width text representation of a Numeric field's data, as stored
