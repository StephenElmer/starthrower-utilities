...
{
    /// <summary>
    /// Represents a PolygonZ shape record (a polygon with elevation and measure values per
    ...
    internal sealed class PolygonZRecord : StarThrower.Gis.EsriLibrary.Internal.GeographyFileRecordContent
    {
        ...
        internal PolygonZRecord(byte[] bytes)
        {
            this.ShapeType = StarThrower.Gis.EsriLibrary.ShapeType.PolygonZ;
            ParseBytes(bytes);
        }
