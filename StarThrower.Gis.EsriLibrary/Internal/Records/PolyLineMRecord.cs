...
{
    /// <summary>
    /// Represents a PolyLineM shape record (a polyline with measure values per vertex).
    ...
    internal sealed class PolyLineMRecord : StarThrower.Gis.EsriLibrary.Internal.GeographyFileRecordContent
    {
        ...
        internal PolyLineMRecord(byte[] bytes)
        {
            this.ShapeType = StarThrower.Gis.EsriLibrary.ShapeType.PolyLineM;
            ParseBytes(bytes);
        }
        ...
        internal override StarThrower.Gis.GeoUtilities.GeoRectangle Extent
        {
            get
            {
                //TODO: #23 — implement Extent once ParseBytes populates bounding box data
        ...
        {
            StarThrower.Gis.GeoUtilities.Shapes.PolylineMShape result = new StarThrower.Gis.GeoUtilities.Shapes.PolylineMShape();
            //TODO: #23 — populate result with parsed parts, points, and M data
            return result;
        }
