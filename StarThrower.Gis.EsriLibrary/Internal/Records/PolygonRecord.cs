...
namespace StarThrower.Gis.EsriLibrary.Internal.Records
{
    internal sealed class PolygonRecord : StarThrower.Gis.EsriLibrary.Internal.GeographyFileRecordContent
    {
        ...
        internal PolygonRecord(byte[] bytes)
        {
            this.ShapeType = StarThrower.Gis.EsriLibrary.ShapeType.Polygon;
            ParseBytes(bytes);
        }
        ...
        internal override string ToXml()
        {
            ...
            for (Int32 i = 0; i < _numParts; i++)
            {
                Int32 numPointsInPart = this.GetNumPointsInPart(i);
        ...
        {
            StarThrower.Gis.GeoUtilities.Shapes.PolygonShape result = new StarThrower.Gis.GeoUtilities.Shapes.PolygonShape();
