...
namespace StarThrower.Gis.EsriLibrary.Internal.Records
{
    ...
    internal sealed class MultiPointMRecord : StarThrower.Gis.EsriLibrary.Internal.GeographyFileRecordContent
    {
        ...
        internal MultiPointMRecord(byte[] bytes)
        {
            this.ShapeType = StarThrower.Gis.EsriLibrary.ShapeType.MultiPointM;
            ParseBytes(bytes);
        }
        ...
        internal override StarThrower.Gis.GeoUtilities.GeoRectangle Extent
        {
            get
            {
                //TODO: #21 — implement Extent once ParseBytes populates bounding box data
        ...
        {
            StarThrower.Gis.GeoUtilities.Shapes.MultipointMShape result = new StarThrower.Gis.GeoUtilities.Shapes.MultipointMShape();
            //TODO: #21 — populate result with parsed point and M data
            return result;
        }
