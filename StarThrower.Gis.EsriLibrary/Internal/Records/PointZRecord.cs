...
{
    /// <summary>
    /// Represents a PointZ shape record (a point with elevation and measure values).
    ...
    /// Tracked in issue #18.
    /// </summary>
    internal sealed class PointZRecord : StarThrower.Gis.EsriLibrary.Internal.GeographyFileRecordContent
    {
        #region Construction

        internal PointZRecord(byte[] bytes)
        {
            this.ShapeType = StarThrower.Gis.EsriLibrary.ShapeType.PointZ;
            ParseBytes(bytes);
        }
        ...
        internal override StarThrower.Gis.GeoUtilities.GeoRectangle Extent
        {
            get
            {
                //TODO: #18 — implement Extent once ParseBytes populates X/Y data
        ...
        {
            StarThrower.Gis.GeoUtilities.Shapes.PointZShape result = new StarThrower.Gis.GeoUtilities.Shapes.PointZShape();
            //TODO: #18 — populate result with parsed X, Y, Z, M values
            return result;
        }
